...
if (save === "Insert") {
    ...
    try {
        shiftStatus.forEach(function (operator) { return updateShiftsRow(operator["Status"], operator["Operator_ID"], operator["Date"]); });
        result = {
            "SavedOnDatabase": "yes"
        };
    }
...
function updateShiftsRow(status, opId, shiftDay) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, entities.shifts.createQueryBuilder()
                        .update()
                        .set({ "Status": status })
